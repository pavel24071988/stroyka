...
if(isset($_POST['changeStatus'])){
    ...
    if(Application::resize($_FILES['avatar']['tmp_name'], "images/users/". $user['id'] ."/". $_FILES['avatar']['name'], 500, 0)){
                        ...
                        <div class="specialist-holder clearfix">
                            <div class="specialist-meta">
                                ...
                                <div class="specialist-personal">
                                    ...
                                    <br/>
                                    <?php if($user['type_of_registration'] === 2){ ?>
                                    <p><b>Наличие СРО и сертификатов:</b> <?php if(!empty($user['cpo'])) echo 'есть'; else echo 'нет'; ?></p>
                                    <?php if(!empty($user['contact_person'])){ ?><p><b>Контактное лицо:</b> <?=$user['contact_person'];?></p><?php } ?>
                                    <?php if(!empty($user['adress_of_organization'])){ ?><p><b>Адрес:</b> <?php echo $user['adress_of_organization']; ?></p><?php } ?>
                                    <?php } ?>
                                    <?php if(!empty($professions_str)){ ?>
                                    <p><b>Виды деятельности:</b></p>
                                    <?php echo '<p>'. implode('</p><p>', $professions_str) .'</p>'; ?>
